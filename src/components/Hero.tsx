      ...
      <div ref={scaleRef} className="h-full">
        <Chapter background="warm" className="h-full !min-h-0">
          ...
          <div className="relative z-10 flex flex-col gap-6 px-6 sm:px-10">
            <p
              ref={labelRef}
              className="ml-2 font-mona text-xs font-bold uppercase tracking-[0.35em] text-ink sm:ml-4 sm:font-bold"
            >
            ...
            >
              <a
                ...
                aria-label="LinkedIn"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-[24px] sm:w-[24px]" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                aria-label="GitHub"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-[26px] sm:w-[26px]" width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a
                ...
                aria-label="Email"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-[28px] sm:w-[28px]" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
